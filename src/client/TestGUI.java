...
public class TestGUI extends JFrame {
	...
	TestGUI currentLoginGUI = null;
	TestRoom currentRoomGUI = null;
	...
	public TestGUI() {
		...
		label.setIcon(new ImageIcon(TestGUI.class.getResource("/res/logo.png")));
